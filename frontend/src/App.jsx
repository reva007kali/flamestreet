...
export default function App() {
  return (
    <Routes>
      ...
      <Route element={<RoleGuard allowRoles={['member', 'trainer', 'courier', 'admin']} />}>
      ...
      <Route element={<RoleGuard allowRoles={['member']} />}>
        <Route element={<MemberLayout />}>
          ...
          <Route path="/member/orders" element={<MemberOrders />} />
            <Route path="/member/articles" element={<Articles basePath="/member" />} />
            <Route path="/member/articles/:slug" element={<ArticleDetail basePath="/member" />} />
      ...
      <Route element={<RoleGuard allowRoles={['trainer']} />}>
        <Route element={<TrainerLayout />}>
          ...
          <Route path="/trainer/articles" element={<Articles basePath="/trainer" />} />
          <Route path="/trainer/articles/:slug" element={<ArticleDetail basePath="/trainer" />} />
          <Route path="/trainer/menu" element={<Menu basePath="/trainer" />} />
          <Route path="/trainer/product/:slug" element={<ProductDetail basePath="/trainer" />} />
      ...
      <Route element={<RoleGuard allowRoles={['courier']} />}>
        <Route element={<CourierLayout />}>
          ...
          <Route path="/courier/delivery/:orderNumber" element={<DeliveryDetail />} />
        </Route>
      </Route>

      <Route element={<RoleGuard allowRoles={['cashier', 'admin']} />}>
        <Route element={<CashierLayout />}>
          <Route path="/cashier" element={<Navigate to="/cashier/queue" replace />} />
      ...
      <Route element={<RoleGuard allowRoles={['admin']} />}>
        <Route element={<AdminLayout />}>
          ...
          <Route path="/admin/payment-methods/new" element={<AdminPaymentMethodForm />} />
          <Route path="/admin/payment-methods/:id" element={<AdminPaymentMethodForm />} />
          <Route path="/admin/promo-banners" element={<AdminPromoBanners />} />
          <Route path="/admin/promo-banners/new" element={<AdminPromoBannerForm />} />
          <Route path="/admin/promo-banners/:id" element={<AdminPromoBannerForm />} />
          ...
          <Route path="/admin/point-settings" element={<AdminPointSettings />} />
