...
export default function Profile() {
  ...
  useEffect(() => {
    ...
    setBio(meQuery.data.flamehub_bio ?? "");
  }, [meQuery.data]);
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 pb-10 px-4">
      <div className="sticky top-10 z-30 -mx-4 border-b border-zinc-900 bg-zinc-950/85 px-4 py-4 backdrop-blur sm:mx-0 sm:rounded-2xl sm:border sm:border-zinc-800">
        <div className="flex items-center justify-between gap-3">
          <div className="min-w-0">
            <h1 className="truncate text-xl font-black text-white tracking-tight">
              Profile Settings
            </h1>
            <p className="truncate text-[11px] font-semibold text-zinc-500">
              Edit akun, bio, photo, dan keamanan dari satu tempat.
            </p>
          </div>
          <Button
      ...
      <div className="grid gap-8 lg:grid-cols-12">
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="relative overflow-hidden rounded-3xl border border-emerald-500/15 bg-gradient-to-br from-emerald-800/20 via-zinc-950 to-black p-6 flex flex-col items-center text-center">
          ...
          <div className="rounded-3xl border border-zinc-800 bg-zinc-950 p-6 sm:p-8">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <textarea
                  rows={4}
                  className="w-full resize-none rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-3 text-white outline-none focus:border-[var(--accent)] focus:ring-1 focus:ring-[var(--accent)] transition-all"
                  placeholder="Bio singkat…"
                  value={bio}
                  onChange={(e) => setBio(e.target.value)}
                />
                <div className="text-[10px] font-semibold text-zinc-500">
                  {String(bio ?? "").length}/160
                </div>
              </div>
